var locations = [
      ...
      ['Arrêt Saint-Germain - Odéon', 48.8527205876594,2.3387769146359005],
	   ['Arrêt Sénat', 48.8492603,2.3361593],
		...
		var contentString ;
		var contentInfoWindow='<html></b></br><a href="http://www.w3schools.com"><img  src="resources/images/streetV.png"></a></html>';
		var currentBusLocation;
		var lat,lon,nextStop,countTime=40,maxo=100;
		var inputLat;
		var inputt;
		var inputLon;
		var inputNextStop;
    ...
    //Script Moving
					...
					{   
						...
						currentBusLocation=coords;
						lat=currentBusLocation.lat;
						lon=currentBusLocation.lng;
						nextStop=currentBusLocation.nextStop;
						
						document.getElementById("formId:lat").value=lat ;
						document.getElementById("formId:lon").value=lon ;
						document.getElementById("formId:nextStop").value=nextStop ;
						document.getElementById("formId:countTime").value=countTime ;
					 ...
					 if (coords.stationHere==1){
						...
						console.log(currentBusLocation.lat);
						console.log(lat);
						console.log("longitude "+lon);
						console.log("nexStation new "+nextStop);
						console.log("************")
					...
					}, 10000 * i, pathCoords[i]);  //le 3 eme parametre de la fct setTimeout is Optional. Additional parameters to pass to the function cela dit  coords va recevoir pathCoords[de i ] chaque fois 
            ...
            inputLat=	document.getElementById("formId:lat").value=lat ;
           
			inputLon=   document.getElementById("formId:lon").value=lon ;
			
			inputNextStop=document.getElementById("formId:nextStop").value=nextStop ;
			inputCounTime=document.getElementById("formId:countTime").value=countTime ;
			}
